...
export const Icons = {
  ...
  orchestr: ({ className, animate = false, ...props }: LucideProps & { animate?: boolean }) => (
    <svg
      ...
      strokeLinejoin="round"
      className={cn(
        'group size-6 text-foreground child:origin-center child:transition child:duration-200 child:ease-in-out',

        className
      )}
      {...props}
    >
      <path d="M2 10v3" className={cn('group-hover:scale-y-[0.6]', animate && 'animate-wave')} />
      <path
        d="M6 6v11"
        className={cn(
          'opacity-90 delay-[60ms] animate-delay-[60ms] group-hover:scale-y-[0.6]',
      ...
      <path
        d="M10 3v18"
        className={cn(
          'opacity-70 delay-[120ms] animate-delay-[120ms] group-hover:scale-y-[0.6]',
          animate && 'animate-wave'
        )}
      />
      <path
        d="M14 8v7"
        className={cn(
          'opacity-60 delay-[180ms] animate-delay-[180ms] group-hover:scale-y-[0.6]',
          animate && 'animate-wave'
        )}
      />
      <path
        d="M18 5v13"
        className={cn(
          'opacity-80 delay-[240ms] animate-delay-[240ms] group-hover:scale-y-[0.6]',
          animate && 'animate-wave'
        )}
      />
      <path
        d="M22 10v3"
        className={cn(
          'opacity-70 delay-[300ms] animate-delay-[300ms] group-hover:scale-y-[0.6]',
          animate && 'animate-wave'
        )}
      />
    </svg>
